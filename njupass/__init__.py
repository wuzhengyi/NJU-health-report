...
class NjuUiaAuth:
    ...
    def __init__(self):
        ...
        self.session.headers.update({
            ...
            'User-Agent': "Mozilla/5.0 (Linux; Android 11; RMX3031 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4515.131 Mobile Safari/537.36 cpdaily/8.2.7 wisedu/8.2.7",
